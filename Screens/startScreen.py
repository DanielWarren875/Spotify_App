...
class start():
    ...
    def startProgram(self, start):
        ...
        scope = 'user-read-private,user-read-email,playlist-read-private,user-library-read,playlist-read-collaborative,user-library-modify,playlist-modify-private,playlist-modify-public'
        type = 'code'
